        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">Krishi Connect</h1>
              <p class="text-white">
...
const apiKey = "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";   // Enter your apikey here
